...
module gotm_light
   ...
   type, extends(type_base_model), public :: type_gotm_light
      ...
      type (type_diagnostic_variable_id) :: id_ext0 ! Surface layer attenuation
...
contains
   ...
   subroutine initialize(self, configunit)
      ...
      call self%register_diagnostic_variable(self%id_ext0, 'ext0', 'm-1', 'surface layer attenuation', &
         standard_variable=standard_variables%surface_layer_attenuation, source=source_do_column)
   ...
   subroutine do_column(self, _ARGUMENTS_DO_COLUMN_)
      ...
      real(rk) :: swr0, dz, swr, par, z, ext, bioext, ext0
      ...
      _DOWNWARD_LOOP_BEGIN_
         ...
         if (z==0.0_rk) then      ! top layer
                 ext0 = ext + (1.0_rk / self%g2) ! sum of bio- and water-attenuation
         !        _SET_DIAGNOSTIC_(self%id_ext0,ext0) ! write out surface layer attenuation for ERGOM
         endif
